...
export default function FileRepo({ items }: { items: RepoItem[] }) {
  ...
  return (
    <div data-swapy-handle className="bg-white/40 dark:bg-white/5 backdrop-blur cursor-grab active:cursor-grabbing flex-1 relative border dark:border-white/10 border-black/20 rounded-md overflow-scroll flex-grow max-[1400px]:hidden">
      <div className="sticky top-0 flex backdrop-blur bg-white/25 dark:bg-black/50 gap-1.5 items-center p-1 rounded-t-lg">
