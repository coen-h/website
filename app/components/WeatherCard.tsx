...
export default function WeatherCard() {
  ...
  return (
    <div className="bg-white/40 dark:bg-white/5 backdrop-blur flex flex-col relative min-h-51 w-full p-2 border dark:border-white/10 border-black/20 rounded-md overflow-hidden max-[1400px]:hidden">
      {weather ? (
        <>
          <Image
